...
public:
	...
	// This is called once per frame and handles the 
	// rendering of the physical object. This will let 
	// you draw a variaty of objects using the Gizmo class
	// and add them to this loop.
	void Draw();
